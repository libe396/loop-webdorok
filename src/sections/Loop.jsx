        ...
        <div className="inner loop-in">
          ...
          <div className="loop-right">
            ...
            <Glass className="loop-card glass-frost" key={st.en}>
              <p className="t18 semibold accent">{st.n} · {st.en}</p>
