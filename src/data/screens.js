import aiScreen from '../assets/screens/ai.webp'
 ...
 * AI 챗봇은 src/assets/screens/ai.webp에서 import — 빌드 해시로 이전 이미지 캐시 방지.
 *   h4.webp   H-4 · 무브바디       (2840:27733)
 * public/img/band.webp   LOOP band 제품 이미지 (2701:56643)
 */
const base = import.meta.env.BASE_URL
export const screen = (code) => code === 'ai' ? aiScreen : `${base}screens/${code}.webp`
